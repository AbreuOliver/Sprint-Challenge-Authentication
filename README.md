...
1. What is the purpose of using _sessions_?
 > Since the HTTP protocol method is stateless - it stores no memory across requests - sessions exist as a place to store data that should be accessed across HTTP requests
2. What does bcrypt do to help us store passwords in a secure manner?
>  Bcryptjs hashes passwords, implements salting and hashes passwords for several rounds
3. What does bcrypt do to slow down attackers?
> Bcrypt mitigates brute-force attacks by adding time to the security algorithm, producing a key derivation function
